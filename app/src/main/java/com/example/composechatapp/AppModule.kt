...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideUser(): UsersModel = UsersModel(null, null, null, null, null, null,null)
    ...
    fun provideAuthRepository(
        ...
        AuthRepositoryImpl(firebaseAuth, firebaseMessaging,fireStore,profileUpdates, userModel)
